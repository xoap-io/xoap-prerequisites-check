<#
	...
	.NOTES
		...
		File Name  : XOAP-Prerequisite-Check-Dedicated-v0.1.1  
...
Param(
    ...
    [string]$XOAPURL = '65637224.xoap.io'
)
...
$URLs = @{
    DSCAPI = "https://api.$($XOAPURL)/ping"
    PackageAPI = "https://api.$($XOAPURL)/packages/Ping"
    Insights = "https://insights.$($XOAPURL)/_plugin/kibana"
    XOAP = "https://$($XOAPURL)"
}
